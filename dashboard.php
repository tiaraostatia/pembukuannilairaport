  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="?dashboard=mata_pelajaran">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-world-2 text-danger text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">mata_pelajaran</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link " href="?dashboard=semester">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link " href="?dashboard=tahun_ajaran">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-collection text-info text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">tahun_ajaran</span>
          </a>
        </li>
      </ul>
    </div>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="logout_proses.php" class="nav-link text-white font-weight-bold px-0">
                    ...
                    <div class="d-flex py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">well</span> from Laur
                        </h6>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Minimum KKM</p>
                    <h5 class="font-weight-bolder">
                    </h5>
                    <p class="mb-0">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Progres kerja</p>
                    <h5 class="font-weight-bolder">
                    </h5>
                    <p class="mb-0">
                      <span class="text-success text-sm font-weight-bolder"></span>
              ...
              if (!empty($_GET['dashboard'])) {
                ...
                } elseif ($_GET['dashboard'] == "siswa") {
                    include "siswa.php";
                } elseif ($_GET['dashboard'] == "siswa-add") {
                    include "siswa_add.php";
                } elseif ($_GET['dashboard'] == "siswa-edit") {
                    include "siswa_edit.php";
                } elseif ($_GET['dashboard'] == "siswa-delete") {
                ...
                } elseif ($_GET['dashboard'] == "penilaian") {
                    include "penilaian.php";
                } elseif ($_GET['dashboard'] == "penilaian-add") {
                    include "penilaian_add.php";
                } elseif ($_GET['dashboard'] == "penilaian-edit") {
                  include "penilaian_edit.php";
                } elseif ($_GET['dashboard'] == "penilaian-delete") {
                    include "penilaian_delete.php";
                } elseif ($_GET['dashboard'] == "semester") {
                    include "semester.php";
                } elseif ($_GET['dashboard'] == "semester-add") {
                    include "semester_add.php";
                } elseif ($_GET['dashboard'] == "semester-edit") {
                  include "semester_edit.php";
                } elseif ($_GET['dashboard'] == "semester-delete") {
                    include "semester_delete.php";
                } elseif ($_GET['dashboard'] == "tahun_ajaran") {
                    include "tahun_ajaran.php";
                } elseif ($_GET['dashboard'] == "tahun_ajaran-add") {
                    include "tahun_ajaran_add.php";
                } elseif ($_GET['dashboard'] == "tahun_ajaran-edit") {
                  include "tahun_ajaran_edit.php";
                } elseif ($_GET['dashboard'] == "tahun_ajaran-delete") {
                    include "tahun_ajaran_delete.php";
                } else {
                    echo "hello";
                }
                } else { 
