...
$pilih = mysqli_query($koneksi, "SELECT * FROM penilaian WHERE id_penilaian='$id_penilaian'");
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $query = mysqli_query ($koneksi, "UPDATE penilaian SET id_penilaian='$id_penilaian',id_siswa='$id_siswa',
    id_mapel='$id_mapel',nilai='$nilai',tanggal_penilaian='$tanggal_penilaian'WHERE jenis_penilaian='$jenis_penilaian'");
    if ($query) {
        echo "<script>
            ...
            <div class="col-md-12">
                ...
                <form action=""method="post">
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php echo $data ['tanggal_penilaian'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="jenis_penilaian" class="form-label">jenis_penilaian</label>
                        <input type="text" id="jenis_penilain" name="jenis_penilaiaan" class="form-control"
                        value="<?php echo $data ['jenis_penilaian'] ?>">
                    </div>
