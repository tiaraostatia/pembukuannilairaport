      ...
      <div class="row">
        ...
        <div class="col-6 text-end">
          <form action="" method="get" class="form-inline">
            <div class="row">
              ...
              <div class="col-5">
                ...
                <input type="hidden" class="form-control" placeholder="Cari" aria-label="First name" name="dashboard" value="kelas">
              </div>
              <div class="col-2">
          ...
          <div class="col-4">
            ...
            <div class="col-1">
            <a class="btn bg-gradient-dark mb-0" href="kelas_excel.php"><i class="fas fa-file-excel" aria-hidden="true"></i></a>
        </div>
        ...
        <?php if (isset($_GET['cari'])) : ?>
          ...
          <tbody>
            <?php while ($data = mysqli_fetch_array($query)) : ?>
              ...
              <td><?php echo $data['id_wali_kelas'] ?></td>
                <td>
